// ============================================================
// FINANCEOS - MONTH LIFECYCLE & DATE VALIDATION UTILITIES (ESM)
// ============================================================
 ...
 */
export function isItemActiveInMonth(item, targetYear, targetMonth) {
 ...
 */
export function parseSelectedMonth(monthStr) {
  if (monthStr && typeof monthStr === "string" && /^\d{4}-\d{1,2}$/.test(monthStr)) {
    ...
    if (year >= 2000 && year <= 2100 && month >= 1 && month <= 12) {
      ...
      return {
        ...
        formatted: `${MONTH_NAMES[month - 1]} ${year}`,
      };
    }
  }
 ...
 */
export function isDateInMonth(dateInput, targetYear, targetMonth) {
